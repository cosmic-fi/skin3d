...
export interface SkinRenderOptions extends RenderOptions {
	/**
...
export interface CapeRenderOptions extends RenderOptions {
	/**
...
export interface EarsRenderOptions extends RenderOptions {
	/**
...
export interface Options {
	 ...
	 * @defaultValue If unspecified, the width will be set to maintain a 1:1 aspect ratio with the height.
	 */
	width?: number;

	/**
	 * The CSS height of the canvas.
	 * @defaultValue If unspecified, the height will be set to maintain a 1:1 aspect ratio with the width.
	 */
	height?: number;
...
export class Render {
	...
	*/
	...
	loadSkin(source: TextureSource | RemoteImage | null, options: SkinRenderOptions = {}): void | Promise<void> {
		if (source === null) {
			this.resetSkin();
	...
	*/
	...
	loadCape<S extends TextureSource | RemoteImage>(
		source: S,
		options?: CapeRenderOptions
	): S extends TextureSource ? void : Promise<void>;
	loadCape(source: TextureSource | RemoteImage | null, options: CapeRenderOptions = {}): void | Promise<void> {
		if (source === null) {
			this.resetCape();
		} else if (isTextureSource(source)) {
	...
	loadEars<S extends TextureSource | RemoteImage>(
		source: S,
		options?: EarsRenderOptions
	): S extends TextureSource ? void : Promise<void>;
	loadEars(source: TextureSource | RemoteImage | null, options: EarsRenderOptions = {}): void | Promise<void> {
		if (source === null) {
			this.resetEars();
		} else if (isTextureSource(source)) {
